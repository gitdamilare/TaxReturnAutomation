using TaxReturnAutomation.Application.Common.Models;
using TaxReturnAutomation.Application.TodoItems.Commands.CreateTodoItem;
using TaxReturnAutomation.Application.TodoItems.Commands.DeleteTodoItem;
using TaxReturnAutomation.Application.TodoItems.Commands.UpdateTodoItem;
using TaxReturnAutomation.Application.TodoItems.Commands.UpdateTodoItemDetail;
using TaxReturnAutomation.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace TaxReturnAutomation.Web.Endpoints;
